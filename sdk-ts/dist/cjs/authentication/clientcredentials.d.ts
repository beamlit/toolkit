...
export declare class ClientCredentials {
    ...
    fetchWithTimeoutAndRetry(url: string, options: RequestInit, timeout: number, level?: number): Promise<Response>;
    /**
