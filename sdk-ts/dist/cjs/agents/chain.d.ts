 ...
 */
export declare function getChainTool(client: RunClient, name: string, description: string, schema: z.ZodType): import("@langchain/core/tools.js").DynamicStructuredTool<z.ZodType<any, z.ZodTypeDef, any>>;
/**
