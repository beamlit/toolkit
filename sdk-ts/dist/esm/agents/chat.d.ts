 ...
 */
export declare function getChatModel(name: string, agentModel?: Model): Promise<OpenAIVoiceReactAgent | BaseChatModel<import("@langchain/core/language_models/chat_models").BaseChatModelCallOptions, import("@langchain/core/messages").AIMessageChunk>>;
/**
